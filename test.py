...
#FRAMES
Top = Frame(root, bd=2,  relief=RIDGE,bg="yellow")
Top.pack(side=TOP, fill=X)
Form = Frame(root, height=200,bg="yellow")
...
lbl_home = Label(Top, text="Courier Management System", font=('times new roman', 20)).pack()
